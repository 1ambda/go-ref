...
type UpdateOneOK struct {
	...
	/*
	  In: Body
	*/
	Payload *rest_model.Access `json:"body,omitempty"`
}
...
func (o *UpdateOneOK) WithPayload(payload *rest_model.Access) *UpdateOneOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update one o k response
func (o *UpdateOneOK) SetPayload(payload *rest_model.Access) {
	o.Payload = payload
}
...
func (o *UpdateOneDefault) WithPayload(payload *rest_model.Error) *UpdateOneDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update one default response
func (o *UpdateOneDefault) SetPayload(payload *rest_model.Error) {
	o.Payload = payload
}
