...
func (o *AddOneCreated) WithPayload(payload *model.Item) *AddOneCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add one created response
func (o *AddOneCreated) SetPayload(payload *model.Item) {
	o.Payload = payload
}
...
func (o *AddOneDefault) WithPayload(payload *model.Error) *AddOneDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add one default response
func (o *AddOneDefault) SetPayload(payload *model.Error) {
	o.Payload = payload
}
