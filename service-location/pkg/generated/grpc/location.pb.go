...
type LocationClient interface {
	Add(ctx context.Context, in *LocationRequest, opts ...grpc.CallOption) (*LocationResponse, error)
}
...
func (c *locationClient) Add(ctx context.Context, in *LocationRequest, opts ...grpc.CallOption) (*LocationResponse, error) {
	out := new(LocationResponse)
	err := grpc.Invoke(ctx, "/pb.Location/Add", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LocationServer interface {
	Add(context.Context, *LocationRequest) (*LocationResponse, error)
}
...
func _Location_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Location/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServer).Add(ctx, req.(*LocationRequest))
	}
...
var fileDescriptor1 = []byte{
	...
	0x85, 0x46, 0x1a, 0xd9, 0x71, 0x71, 0xc0, 0xd4, 0x08, 0x19, 0x71, 0x31, 0x3b, 0xa6, 0xa4, 0x08,
	0xa1, 0x68, 0x84, 0xba, 0x5c, 0x4a, 0x04, 0x55, 0x10, 0x62, 0xb9, 0x12, 0x43, 0x12, 0x1b, 0x38,
	0xe8, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xa5, 0xe3, 0xd7, 0xd1, 0x4c, 0x01, 0x00, 0x00,
}
