...
type UpdateOneOK struct {
	...
	/*
	  In: Body
	*/
	Payload *model.Item `json:"body,omitempty"`
}
...
func (o *UpdateOneOK) WithPayload(payload *model.Item) *UpdateOneOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update one o k response
func (o *UpdateOneOK) SetPayload(payload *model.Item) {
	o.Payload = payload
}
...
func (o *UpdateOneDefault) WithPayload(payload *model.Error) *UpdateOneDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update one default response
func (o *UpdateOneDefault) SetPayload(payload *model.Error) {
	o.Payload = payload
}
