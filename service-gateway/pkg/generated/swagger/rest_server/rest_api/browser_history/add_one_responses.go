...
func (o *AddOneCreated) WithPayload(payload *rest_model.BrowserHistory) *AddOneCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add one created response
func (o *AddOneCreated) SetPayload(payload *rest_model.BrowserHistory) {
	o.Payload = payload
}
...
func (o *AddOneDefault) WithPayload(payload *rest_model.RestError) *AddOneDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add one default response
func (o *AddOneDefault) SetPayload(payload *rest_model.RestError) {
	o.Payload = payload
}
